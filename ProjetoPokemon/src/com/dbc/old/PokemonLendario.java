...
public class PokemonLendario extends Pokemon implements Impressao {
    ...
    public PokemonLendario(Integer numero, String nome, Integer level, com.dbc.old.Status status, Double altura, Double peso,
    ...
    public Integer multiplicadorDeStatus(){
         ...
         com.dbc.old.Status status = new Status(hp, ataque, defesa, especialAtaque, especialDefesa, velocidade);
